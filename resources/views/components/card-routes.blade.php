<div>
  ...
  <div class="d-flex justify-content-end">
    ...
    <!-- mira si algún usuario está logueado -->
    @if (Auth::check())
    <!-- id de la ruta que se le pasa al favouritescontroller en el store $routeID a traves de la ruta -->
    <a href="/rutas/{{$route->id}}/fav">
      <!-- busca dentro de la pivot si el usuario logueado está vinculado a la pivot con esta ruta, si ya le ha dado a favoritos a esta ruta-->
