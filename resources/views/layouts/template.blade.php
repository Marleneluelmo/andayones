...
<head>
    ...
    <title>Andayones</title>

    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
    <script src="https://kit.fontawesome.com/b65dd74c47.js" crossorigin="anonymous"></script>
...
<body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('fav.index') }}">
                                    {{ __('Favoritos') }}
                                </a>
        ...
        <header>
            ...
            <div>
                <div class="d-flex align-items-center justify-content-center mb-3 container">
                    ...
                    <div>
                        <div class="me-5">
                            <a href="{{route('welcome')}}"><img src="{{asset('storage/logoandayonestransp.png')}}" ; alt="" width="150" height="auto">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('picos')}}">PICOS DE EUROPA</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('ferrata')}}">FERRATAS</a>
                                        </li>
                                        <li class="nav-item">
    ...
    <footer>
        <div id="footer" class="d-flex justify-content-center align-content-center pt-2">
            <h5>&copy; Andayones 2022</h5>
        </div>
    </footer>
...
<!-- @if (Route::has('login'))
    <div class="d-flex justify-content-end mt-3 me-4">
        <div class= "me-2">
        @auth
            <a href="{{ url('/home') }}" type="button" id="login-btn" class="btn rounded-pill">Home</a>
        @else
            <a href="{{ route('login') }}" type="button" id="login-btn" class="btn rounded-pill">Login</a>
            </div>
            @if (Route::has('register'))
...
<!-- mi anterior codigo de botones login y register -->
