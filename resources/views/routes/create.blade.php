...
<h3>Añadir una ruta</h3>

<div class="d-flex justify-content-center align-items-center mt-4">
  <div class="card" style="width: 40rem">
    <!-- ruta que Lleva al store con post para que guarde los datos en la db-->
    <form class="ms-5 me-5 mt-5 mb-5" action="{{route('routes.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group mb-4">
        ...
        <input type="text" class="form-control" id="formGroupExampleInput2" name="distance">
      </div>
      <div class="form-group mb-4">
