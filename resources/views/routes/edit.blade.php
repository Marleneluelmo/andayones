...
<!-- METODO CREATE formulario del admin para crear una ruta -->
@section('content')

<h3>Actualizar una ruta</h3>

<div class="d-flex justify-content-center align-items-center mt-4">
  <div class="card" style="width: 40rem">
    <!-- ruta que Lleva al store con post para que GUARDE LOS DATOS en la db-->
    <form class="ms-5 me-5 mt-5 mb-5" action="{{route('routes.update', $route)}}" method="POST" enctype="multipart/form-data">
      @method('PUT')
      ...
      <div class="form-group mb-4">
        ...
        <input type="text" class="form-control" id="formGroupExampleInput2" name="distance" value="{{$route->distance}}">
      </div>
      <div class="form-group mb-4">
      ...
      <div class="form-group">
        <div class="col-auto my-1 mb-4">
          ...
          <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="difficulty">{{$route->difficulty}}
